...
下载链接：[rag_starter.zip](./nlp251113.assets/rag_starter.zip)
...
1. 访问 vscode 官网。
2. 下载 ubuntu arm64 .deb。
3. 执行 `sudo dpkg -i 下载的包名.deb` 安装。

### 0.4 本地笔记本装 MobaXterm

下载链接：[MobaXterm_Portable_v25.3.zip](./nlp251113.assets/MobaXterm_Portable_v25.3.zip)
